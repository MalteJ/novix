...
#if defined(DLG_HAVE_NCURSESW_NCURSES_H)
#include <ncursesw/ncurses.h>
#elif defined(DLG_HAVE_NCURSES_NCURSES_H)
#include <ncurses/ncurses.h>
#elif defined(DLG_HAVE_NCURSES_CURSES_H)
#include <ncurses/curses.h>
#elif defined(DLG_HAVE_NCURSES_H)
#include <ncurses.h>
#else
#include <curses.h>
#if defined(DLG_HAVE_UNCTRL_H)
...
#ifdef DLG_ENABLE_NLS
#include <libintl.h>
#include <langinfo.h>
#define _(s) dgettext(DLG_PACKAGE, s)
#else
#undef _
#define _(s) s
#endif
...
#ifndef DLG_GCC_NORETURN
#define DLG_GCC_NORETURN /*nothing*/
#endif

#ifndef DLG_GCC_UNUSED
#define DLG_GCC_UNUSED /*nothing*/
#endif

#ifndef DLG_HAVE_WGET_WCH
#undef DLG_USE_WIDE_CURSES
#endif
...
#ifndef DLG_HAVE_GETBEGYX
#undef  getbegyx
#define getbegyx(win,y,x)	(y = (win)?(win)->_begy:ERR, x = (win)?(win)->_begx:ERR)
#endif

#ifndef DLG_HAVE_GETMAXYX
#undef  getmaxyx
#define getmaxyx(win,y,x)	(y = (win)?(win)->_maxy:ERR, x = (win)?(win)->_maxx:ERR)
#endif

#ifndef DLG_HAVE_GETPARYX
#undef  getparyx
#define getparyx(win,y,x)	(y = (win)?(win)->_pary:ERR, x = (win)?(win)->_parx:ERR)
#endif

#if !defined(DLG_HAVE_WGETPARENT) && defined(DLG_HAVE_WINDOW__PARENT)
#undef  wgetparent
#define wgetparent(win)		((win) ? (win)->_parent : 0)
#endif

#if !defined(DLG_HAVE_WSYNCUP)
#undef wsyncup
#define wsyncup(win) /* nothing */
#endif

#if !defined(DLG_HAVE_WCURSYNCUP)
#undef wcursyncup
...
#if !(defined(DLG_HAVE_GETBEGX) && defined(DLG_HAVE_GETBEGY))
#undef getbegx
#undef getbegy
...
#if !(defined(DLG_HAVE_GETCURX) && defined(DLG_HAVE_GETCURY))
#undef getcurx
#undef getcury
...
#if !(defined(DLG_HAVE_GETMAXX) && defined(DLG_HAVE_GETMAXY))
#undef getmaxx
#undef getmaxy
...
#if !(defined(DLG_HAVE_GETPARX) && defined(DLG_HAVE_GETPARY))
#undef getparx
#undef getpary
...
#ifdef DLG_HAVE_RC_FILE2
    int ul;			/* true if underline */
    int rv;			/* true if reverse */
#endif /* DLG_HAVE_RC_FILE2 */
#endif /* DLG_HAVE_COLOR */
...
extern void dlg_exit(int /*code*/) DLG_GCC_NORETURN;
...
extern void dlg_exiterr(const char *, ...) DLG_GCC_NORETURN GCC_PRINTFLIKE(1,2);
...
#if defined(DLG_HAVE_CURSES_EXIT)
/* just use curses_exit() */
#elif defined(DLG_HAVE__NC_FREE_AND_EXIT)
